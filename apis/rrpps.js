...
router.post('/import-rrpp', autentication.checkToken, multipartMiddleware, function(req, res) {
...
// Define the home page route
router.post('/new-rrpp', autentication.checkToken, function(req, res) { 
...
router.get('/select-boss', autentication.checkToken, (req, res)=>{
